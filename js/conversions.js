/**
 * Alejandro Carvajal Conversion Tracking v1.0
 * ────────────────────────────────────────────────────────────────────
...
window.Alejandro CarvajalConversions = (function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    try {
      localStorage.setItem('Alejandro Carvajal_last_wa', JSON.stringify({
  ...
  window.addEventListener('beforeunload', function() {
    if (!_formStarted) return;
    var submitted = sessionStorage.getItem('Alejandro Carvajal_form_ok');
    if (submitted) return;
  ...
  function trackFormSubmitOk() {
    sessionStorage.setItem('Alejandro Carvajal_form_ok', '1');
  }
