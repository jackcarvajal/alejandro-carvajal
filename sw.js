// Alejandro Carvajal CAD/CAM — Service Worker v5.4
const CACHE = 'alejandro-v12';
...
self.addEventListener('push', e => {
  let data = { title: '🦷 Alejandro Carvajal Lab', body: 'Tu caso está listo.', tag: 'caso', url: '/seguimiento-caso' };
